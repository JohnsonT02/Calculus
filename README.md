...
<head>
    ...
    <title>Calculus Hub - Your Gateway to Mathematical Understanding</title>
    ...
    <style>
        ...
        .header-bg {
            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); /* Gradient purple */
        }
        .btn-primary {
        ...
        .footer-bg {
            ...
            color: #cbd5e1; /* Light gray for footer text */
        }
        ...
        /* Solution styles (kept for reference, but not used now) */
        .solution-step {
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="card">
                    <div>
                        ...
                        <p class="text-gray-600">
                            ...
                            You will learn their unique differentiation and integration rules, including the natural logarithmic function and the natural exponential function.
                ...
                <div class="card">
                    ...
                    <button class="btn-primary mt-6 view-problems-btn" data-chapter="8">View Practice Problems</button>
                </div>
                <div class="card">
                    <div>
                ...
                <div class="card">
                    <div>
                        ...
                        <p class="text-gray-600">
                            ...
                            Applications include finding extrema of functions of several variables and solving optimization problems
    ...
    <section id="formulas" class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <div class="max-w-4xl mx-auto text-lg leading-relaxed text-gray-700 space-y-6">
                ...
                <h3 class="text-2xl font-semibold text-gray-800 mt-6 mb-2">Basic Integration Formulas</h3>
                <ul class="list-disc list-inside space-y-2 pl-4">
    ...
    <section id="practice" class="py-16 bg-gray-50">
        <div class="container mx-auto px-4 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                ...
                <div class="card text-left">
                    <h3 class="text-2xl font-semibold text-gray-800 mb-3">Leverage Digital Resources</h3>
                    <p class="text-gray-600 mb-4">
            ...
            <form class="max-w-lg mx-auto bg-white p-8 rounded-xl shadow-lg">
                ...
                <div class="mb-6">
                    <textarea id="message" name="message" rows="5" placeholder="Your Message"
                              class="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:outline-none focus:border-indigo-500 transition duration-200" required></textarea>
                </div>
    ...
    <script>
        ...
        const practiceProblems = {
            ...
            "1": [
                ...
                {
                    problem: "3. Determine if $f(x) = \\begin{cases} x^2+1 & x < 2 \\\\ 3x-1 & x \\ge 2 \\end{cases}$ is continuous at $x=2$.",
                },
                {
            ...
            "2": [
                ...
                {
                    problem: "20. If $f(x) = \\sqrt[3]{x}$, find $f'(x)$.",
                },
                {
            ...
            "3": [
                ...
                {
                    problem: "30. A boat is pulled toward a dock by a rope with one end attached to the front of the boat and the other end passing through a ring on the dock 6 ft above the front of the boat. The rope is hauled in at a rate of 2 ft/s. How fast is the boat approaching the dock when 10 ft of rope are out?",
                },
                {
            ...
            "4": [
                {
                    problem: "1. Evaluate $\\int (x^3 - 2x^2 + 5) dx$.",
                },
                {
            ...
            "6": [
                ...
                {
                    problem: "14. Verify that $y = \\sin(x) + C\\cos(x)$ is a solution to $\\frac{dy}{dx} + y \\tan(x) = \\cos(x)$.",
                },
                {
            ...
            "7": [
                ...
                {
                    problem: "20. Find the work done in pumping water out of a cylindrical tank of radius 2 ft and height 10 ft, if the tank is full and the water is pumped to a height of 5 ft above the top of the tank.",
                },
                {
                ...
                {
                    problem: "37. Find the arc length of the curve $x = \\cos(t)$, $y = \\sin(t)$ from $t=0$ to $t=\\pi$.",
                },
                {
            ...
            "8": [
                ...
                {
                    problem: "32. Evaluate $\\int \\frac{1}{(x^2+1)^2} dx$.",
                },
                {
            ...
            "9": [
                ...
                {
                    problem: "6. Determine if the series $\\sum_{n=1}^{\\infty} \\frac{(-1)^n}{n}$ converges or diverges.",
                },
                {
                ...
                {
                    problem: "32. Determine if the series $\\sum_{n=1}^{\\infty} \\frac{n}{e^n}$ converges or diverges.",
                },
                {
                    problem: "33. Find the radius and interval of convergence for the power series $\\sum_{n=0}^{\\infty} \\frac{(x+1)^n}{2^n}$.",
                },
                {
                    problem: "34. Determine if the series $\\sum_{n=1}^{\\infty} \\frac{(-1)^n}{\\sqrt{n}}$ converges or diverges.",
                },
                {
                    problem: "35. Find the sum of the series $\\sum_{n=2}^{\\infty} \\frac{1}{n^2-1}$.",
                },
                {
                    problem: "36. Determine if the series $\\sum_{n=1}^{\\infty} \\frac{\\arctan(n)}{n^2+1}$ converges or diverges.",
                },
                {
                    problem: "37. Find the Taylor series for $f(x) = e^x$ centered at $a=1$.",
                },
                {
                    problem: "38. Determine if the series $\\sum_{n=1}^{\\infty} \\frac{n^3}{n!}$ converges or diverges.",
                },
                {
                    problem: "39. Find the radius and interval of convergence for the power series $\\sum_{n=1}^{\\infty} \\frac{x^n}{n \\cdot 3^n}$.",
                },
                {
                    problem: "40. Determine if the series $\\sum_{n=1}^{\\infty} \\frac{1}{n^p}$ converges or diverges for various $p$ values.",
                },
                {
                    problem: "41. Find the Maclaurin series for $f(x) = \\sinh(x)$.",
                },
                {
                    problem: "42. Determine if the series $\\sum_{n=1}^{\\infty} \\frac{n!}{e^n}$ converges or diverges.",
                },
                {
                    problem: "43. Find the sum of the series $\\sum_{n=0}^{\\infty} \\frac{1}{n!}$.",
                },
                {
                    problem: "44. Determine if the series $\\sum_{n=1}^{\\infty} \\frac{\\sin(n)}{n^3}$ converges or diverges.",
                },
                {
                    problem: "45. Find the Taylor series for $f(x) = \\cos(x)$ centered at $a=\\frac{\\pi}{2}$.",
                }
            ],
            "10": [
                {
                    problem: "1. Identify the conic section represented by $x^2 + 4y^2 = 4$. Sketch its graph.",
                },
                {
                    problem: "2. Find the equation of the parabola with focus $(0, 2)$ and directrix $y = -2$.",
                },
                {
                    problem: "3. Eliminate the parameter to find the Cartesian equation for $x = t+1$, $y = t^2$.",
                },
                {
                    problem: "4. Convert the polar coordinates $(2, \\frac{\\pi}{3})$ to rectangular coordinates.",
                },
                {
                    problem: "5. Convert the rectangular coordinates $(1, -1)$ to polar coordinates.",
                },
                {
                    problem: "6. Find the equation of the ellipse with foci $(\\pm 3, 0)$ and major axis length 10.",
                },
                {
                    problem: "7. Find the equation of the hyperbola with foci $(\\pm 5, 0)$ and vertices $(\\pm 3, 0)$.",
                },
                {
                    problem: "8. Find $\\frac{dy}{dx}$ for the parametric equations $x = t^3 - 3t$, $y = t^2 - 5$.",
                },
                {
                    problem: "9. Find the area of the region enclosed by the polar curve $r = 2\\sin(\\theta)$.",
                },
                {
                    problem: "10. Sketch the graph of the polar equation $r = 1 + \\cos(\\theta)$.",
                },
                {
                    problem: "11. Identify the conic section represented by $y^2 - 2x + 4y + 6 = 0$.",
                },
                {
                    problem: "12. Find the equation of the parabola with vertex $(1, -2)$ and focus $(1, 0)$.",
                },
                {
                    problem: "13. Eliminate the parameter to find the Cartesian equation for $x = 4\\cos(\\theta)$, $y = 3\\sin(\\theta)$.",
                },
                {
                    problem: "14. Convert the polar equation $r = 4\\cos(\\theta)$ to a rectangular equation.",
                },
                {
                    problem: "15. Convert the rectangular equation $x^2 + y^2 = 9$ to a polar equation.",
                },
                {
                    problem: "16. Find the equation of the ellipse with vertices $(0, \\pm 5)$ and minor axis length 6.",
                },
                {
                    problem: "17. Find the equation of the hyperbola with vertices $(0, \\pm 2)$ and asymptotes $y = \\pm 2x$.",
                },
                {
                    problem: "18. Find the arc length of the parametric curve $x = \\cos(t)$, $y = \\sin(t)$ from $t=0$ to $t=\\pi$.",
                },
                {
                    problem: "19. Find the area of the region enclosed by the polar curve $r = 3\\cos(2\\theta)$.",
                },
                {
                    problem: "20. Sketch the graph of the polar equation $r = 2\\theta$ (Archimedean spiral).",
                },
                {
                    problem: "21. Classify the conic section given by $4x^2 - 9y^2 - 16x - 18y - 29 = 0$.",
                },
                {
                    problem: "22. Find the equation of the parabola with vertex $(0, 0)$ and directrix $x = 3$.",
                },
                {
                    problem: "23. Eliminate the parameter to find the Cartesian equation for $x = \\sqrt{t}$, $y = t-1$.",
                },
                {
                    problem: "24. Convert the polar coordinates $(-1, \\frac{3\\pi}{4})$ to rectangular coordinates.",
                },
                {
                    problem: "25. Convert the rectangular coordinates $(-\\sqrt{3}, 1)$ to polar coordinates.",
                },
                {
                    problem: "26. Find the equation of the ellipse with center $(2, 1)$, major axis parallel to the x-axis with length 8, and minor axis length 4.",
                },
                {
                    problem: "27. Find the equation of the hyperbola with center $(0, 0)$, vertex $(4, 0)$, and focus $(5, 0)$.",
                },
                {
                    problem: "28. Find $\\frac{d^2y}{dx^2}$ for the parametric equations $x = t^2$, $y = t^3$.",
                },
                {
                    problem: "29. Find the length of the polar curve $r = e^{\\theta}$ from $\\theta=0$ to $\\theta=\\pi$.",
                },
                {
                    problem: "30. Sketch the graph of the polar equation $r = 2\\cos(3\\theta)$.",
                },
                {
                    problem: "31. Identify the conic section represented by $x^2 + y^2 - 6x + 4y + 4 = 0$.",
                },
                {
                    problem: "32. Find the equation of the parabola with focus $(3, 4)$ and directrix $x = 1$.",
                },
                {
                    problem: "33. Eliminate the parameter to find the Cartesian equation for $x = \\sec(t)$, $y = \\tan(t)$.",
                },
                {
                    problem: "34. Convert the polar equation $r = \\frac{2}{1-\\cos(\\theta)}$ to a rectangular equation.",
                },
                {
                    problem: "35. Convert the rectangular equation $y = x$ to a polar equation.",
                },
                {
                    problem: "36. Find the equation of the ellipse with foci $(0, \\pm 4)$ and major axis length 10.",
                },
                {
                    problem: "37. Find the equation of the hyperbola with vertices $(\\pm 1, 0)$ and asymptotes $y = \\pm 3x$.",
                },
                {
                    problem: "38. Find the area of the surface generated by revolving the parametric curve $x = t^3$, $y = t^2$ ($0 \\le t \\le 1$) about the x-axis.",
                },
                {
                    problem: "39. Find the area of the region common to $r = 3\\cos(\\theta)$ and $r = 1 + \\cos(\\theta)$.",
                },
                {
                    problem: "40. Sketch the graph of the polar equation $r = \\sin(2\\theta)$.",
                },
                {
                    problem: "41. Classify the conic section given by $x^2 + 2y^2 - 4x + 4y - 2 = 0$.",
                },
                {
                    problem: "42. Find the equation of the parabola with vertex $(0, 0)$ and focus $(-2, 0)$.",
                },
                {
                    problem: "43. Eliminate the parameter to find the Cartesian equation for $x = e^t$, $y = e^{2t}$.",
                },
                {
                    problem: "44. Convert the polar equation $r = \\frac{3}{2+\\sin(\\theta)}$ to a rectangular equation.",
                },
                {
                    problem: "45. Convert the rectangular equation $x^2 + y^2 - 4x = 0$ to a polar equation.",
                }
            ],
            "11": [
                {
                    problem: "1. Find the dot product of vectors $\\mathbf{u} = \\langle 1, -2, 3 \\rangle$ and $\\mathbf{v} = \\langle 4, 0, -1 \\rangle$.",
                },
                {
                    problem: "2. Find the cross product of vectors $\\mathbf{u} = \\langle 1, 2, 0 \\rangle$ and $\\mathbf{v} = \\langle 3, -1, 4 \\rangle$.",
                },
                {
                    problem: "3. Find the equation of the plane passing through the point $(1, 2, -3)$ and perpendicular to the vector $\\mathbf{n} = \\langle 2, -1, 4 \\rangle$.",
                },
                {
                    problem: "4. Find the distance between the points $(1, 2, 3)$ and $(4, -1, 5)$.",
                },
                {
                    problem: "5. Find the angle between the vectors $\\mathbf{u} = \\langle 1, 1, 0 \\rangle$ and $\\mathbf{v} = \\langle 0, 1, 1 \\rangle$.",
                },
                {
                    problem: "6. Find the parametric equations of the line passing through points $(1, 2, 3)$ and $(4, 5, 6)$.",
                },
                {
                    problem: "7. Convert the point $(1, \\frac{\\pi}{2}, 3)$ from cylindrical to rectangular coordinates.",
                },
                {
                    problem: "8. Convert the point $(2, \\frac{\\pi}{4}, \\frac{\\pi}{3})$ from spherical to rectangular coordinates.",
                },
                {
                    problem: "9. Find the projection of $\\mathbf{u} = \\langle 3, 1, 2 \\rangle$ onto $\\mathbf{v} = \\langle 1, -1, 0 \\rangle$.",
                },
                {
                    problem: "10. Find the area of the parallelogram with adjacent sides $\\mathbf{u} = \\langle 1, 0, 2 \\rangle$ and $\\mathbf{v} = \\langle 0, 3, 1 \\rangle$.",
                },
                {
                    problem: "11. Find the volume of the parallelepiped determined by vectors $\\mathbf{u} = \\langle 1, 1, 0 \\rangle$, $\\mathbf{v} = \\langle 0, 1, 1 \\rangle$, and $\\mathbf{w} = \\langle 1, 0, 1 \\rangle$.",
                },
                {
                    problem: "12. Find the equation of the sphere with center $(1, -2, 3)$ and radius 4.",
                },
                {
                    problem: "13. Find the derivative of the vector-valued function $\\mathbf{r}(t) = \\langle t^2, \\sin(t), e^t \\rangle$.",
                },
                {
                    problem: "14. Find the unit tangent vector $\\mathbf{T}(t)$ for $\\mathbf{r}(t) = \\langle \\cos(t), \\sin(t), t \\rangle$.",
                },
                {
                    problem: "15. Find the length of the curve $\\mathbf{r}(t) = \\langle 3t, 4t, 5t \\rangle$ from $t=0$ to $t=1$.",
                },
                {
                    problem: "16. Find the equation of the plane containing the points $(1, 0, 0)$, $(0, 1, 0)$, and $(0, 0, 1)$.",
                },
                {
                    problem: "17. Convert the rectangular point $(1, 1, 1)$ to cylindrical coordinates.",
                },
                {
                    problem: "18. Convert the rectangular point $(1, 1, 1)$ to spherical coordinates.",
                },
                {
                    problem: "19. Find the work done by the force $\\mathbf{F} = \\langle 2, 3, -1 \\rangle$ moving an object from $P(1, 1, 1)$ to $Q(3, 2, 0)$.",
                },
                {
                    problem: "20. Determine if the vectors $\\mathbf{u} = \\langle 1, -1, 2 \\rangle$ and $\\mathbf{v} = \\langle 2, 0, 1 \\rangle$ are orthogonal.",
                },
                {
                    problem: "21. Find the equation of the line of intersection of the planes $x+y+z=1$ and $x-y+2z=0$.",
                },
                {
                    problem: "22. Find the distance from the point $(1, 1, 1)$ to the plane $x+2y-2z=5$.",
                },
                {
                    problem: "23. Find the integral of the vector-valued function $\\mathbf{r}(t) = \\langle t, t^2, t^3 \\rangle$.",
                },
                {
                    problem: "24. Find the velocity and acceleration vectors for $\\mathbf{r}(t) = \\langle e^t, e^{-t}, t \\rangle$.",
                },
                {
                    problem: "25. Find the curvature of the curve $\\mathbf{r}(t) = \\langle t, t^2, 0 \\rangle$.",
                },
                {
                    problem: "26. Find the equation of the plane that contains the line $x=1+2t, y=2-t, z=3t$ and is parallel to the plane $x+y-z=5$.",
                },
                {
                    problem: "27. Find the area of the triangle with vertices $P(1, 0, 0)$, $Q(0, 1, 0)$, and $R(0, 0, 1)$.",
                },
                {
                    problem: "28. Find the equation of the cylinder $x^2+y^2=4$ in cylindrical coordinates.",
                },
                {
                    problem: "29. Find the equation of the sphere $x^2+y^2+z^2=9$ in spherical coordinates.",
                },
                {
                    problem: "30. Find the scalar projection of $\\mathbf{u} = \\langle 2, -1, 3 \\rangle$ onto $\\mathbf{v} = \\langle 1, 2, 1 \\rangle$.",
                },
                {
                    problem: "31. Find the equation of the plane parallel to $2x+3y-z=1$ and passing through $(1, 0, 0)$.",
                },
                {
                    problem: "32. Find the intersection point of the line $x=t, y=t, z=t$ and the plane $x+y+z=6$.",
                },
                {
                    problem: "33. Find the tangent line to the curve $\\mathbf{r}(t) = \\langle t, t^2, t^3 \\rangle$ at $t=1$.",
                },
                {
                    problem: "34. Find the length of the curve $\\mathbf{r}(t) = \\langle e^t \\cos t, e^t \\sin t, e^t \\rangle$ from $t=0$ to $t=1$.",
                },
                {
                    problem: "35. Find the equation of the plane passing through $(1, 2, 3)$ and containing the line $x=1+t, y=2-t, z=3+2t$.",
                },
                {
                    problem: "36. Find the distance between the skew lines $L_1: x=1+t, y=2+t, z=3+t$ and $L_2: x=4+s, y=1+s, z=5+s$.",
                },
                {
                    problem: "37. Convert the cylindrical equation $r=3$ to rectangular coordinates.",
                },
                {
                    problem: "38. Convert the spherical equation $\\phi = \\frac{\\pi}{4}$ to rectangular coordinates.",
                },
                {
                    problem: "39. Find the component of $\\mathbf{u} = \\langle 1, 2, 3 \\rangle$ orthogonal to $\\mathbf{v} = \\langle 1, 1, 1 \\rangle$.",
                },
                {
                    problem: "40. Find the equation of the plane passing through $(1, 0, 0)$, $(0, 1, 0)$, and $(1, 1, 1)$.",
                },
                {
                    problem: "41. Find the intersection of the sphere $x^2+y^2+z^2=4$ and the plane $z=1$.",
                },
                {
                    problem: "42. Find the velocity and position of a particle if $\\mathbf{a}(t) = \\langle 0, 0, -9.8 \\rangle$, $\\mathbf{v}(0) = \\langle 1, 0, 10 \\rangle$, and $\\mathbf{r}(0) = \\langle 0, 0, 0 \\rangle$.",
                },
                {
                    problem: "43. Find the unit normal vector $\\mathbf{N}(t)$ for $\\mathbf{r}(t) = \\langle \\cos(t), \\sin(t), t \\rangle$.",
                },
                {
                    problem: "44. Find the equation of the plane that contains the points $A(1, 2, 3)$, $B(2, 3, 1)$, and $C(3, 1, 2)$.",
                },
                {
                    problem: "45. Find the distance from the point $(0, 0, 0)$ to the line $x=1+t, y=2+t, z=3+t$.",
                }
            ],
            "12": [
                {
                    problem: "1. Find the first partial derivatives of $f(x, y) = x^3 y^2 + 2x y^4$.",
                },
                {
                    problem: "2. Find the gradient of $f(x, y, z) = x^2 y + y^2 z - 3xz$.",
                },
                {
                    problem: "3. Find the directional derivative of $f(x, y) = x^2 y^3$ at $(1, 2)$ in the direction of $\\mathbf{v} = \\langle 3, 4 \\rangle$.",
                },
                {
                    problem: "4. Find the local extrema of $f(x, y) = x^2 + y^2 - 2x - 6y + 14$.",
                },
                {
                    problem: "5. Use Lagrange multipliers to find the maximum value of $f(x, y) = xy$ subject to $x^2 + y^2 = 1$.",
                },
                {
                    problem: "6. Find the equation of the tangent plane to $z = x^2 + y^2$ at the point $(1, 1, 2)$.",
                },
                {
                    problem: "7. Find the second partial derivatives of $f(x, y) = e^{xy}$.",
                },
                {
                    problem: "8. If $z = x^2 + y^2$ and $x = r \\cos(\\theta)$, $y = r \\sin(\\theta)$, find $\\frac{\\partial z}{\\partial r}$ and $\\frac{\\partial z}{\\partial \\theta}$ using the Chain Rule.",
                },
                {
                    problem: "9. Find the critical points of $f(x, y) = x^3 + y^3 - 3xy$.",
                },
                {
                    problem: "10. Find the absolute maximum and minimum values of $f(x, y) = x^2 - y^2$ on the disk $x^2 + y^2 \\le 1$.",
                },
                {
                    problem: "11. Find the directional derivative of $f(x, y, z) = xyz$ at $(1, 2, 3)$ in the direction of $\\mathbf{v} = \\langle 1, 1, 1 \\rangle$.",
                },
                {
                    problem: "12. Find the equation of the normal line to $z = x^2 + y^2$ at the point $(1, 1, 2)$.",
                },
                {
                    problem: "13. Determine if the limit exists: $\\lim_{(x, y) \\to (0, 0)} \\frac{xy}{x^2+y^2}$.",
                },
                {
                    problem: "14. Find the domain and range of $f(x, y) = \\sqrt{9 - x^2 - y^2}$.",
                },
                {
                    problem: "15. Find the linear approximation of $f(x, y) = e^{xy}$ at $(0, 0)$.",
                },
                {
                    problem: "16. Find the maximum rate of change of $f(x, y) = x^2 y^3$ at $(1, 2)$.",
                },
                {
                    problem: "17. Find the tangent plane to $x^2 + y^2 + z^2 = 9$ at $(2, 2, 1)$.",
                },
                {
                    problem: "18. Find the critical points of $f(x, y) = 4 + 2x^2 + 3y^2$.",
                },
                {
                    problem: "19. Use Lagrange multipliers to find the dimensions of a rectangular box with largest volume if it is inscribed in a sphere of radius $R$.",
                },
                {
                    problem: "20. Determine if the function $f(x, y) = \\frac{x^2 y}{x^4+y^2}$ is continuous at $(0, 0)$.",
                },
                {
                    problem: "21. Find the first partial derivatives of $f(x, y, z) = \\ln(x^2+y^2+z^2)$.",
                },
                {
                    problem: "22. Find the gradient of $f(x, y) = \\arctan(\\frac{y}{x})$.",
                },
                {
                    problem: "23. Find the directional derivative of $f(x, y) = \\sqrt{x^2+y^2}$ at $(3, 4)$ in the direction of $\\mathbf{v} = \\langle 1, -1 \\rangle$.",
                },
                {
                    problem: "24. Classify the critical points of $f(x, y) = x^4 + y^4 - 4xy + 1$.",
                },
                {
                    problem: "25. Use Lagrange multipliers to find the points on the sphere $x^2+y^2+z^2=1$ closest to and farthest from the point $(1, 2, 3)$.",
                },
                {
                    problem: "26. Find the equation of the tangent plane to $z = xy$ at $(1, 1, 1)$.",
                },
                {
                    problem: "27. If $w = x^2 y - y^2 z$ where $x = \\cos t$, $y = \\sin t$, $z = t$, find $\\frac{dw}{dt}$.",
                },
                {
                    problem: "28. Find the critical points of $f(x, y) = x e^{-x^2-y^2}$.",
                },
                {
                    problem: "29. Find the absolute maximum and minimum values of $f(x, y) = xy$ on the square region $0 \\le x \\le 1, 0 \\le y \\le 1$.",
                },
                {
                    problem: "30. Find the Cobb-Douglas production function $P(L, K) = bL^{\\alpha}K^{1-\\alpha}$ if $P(1,1)=100$, and the marginal productivities are $P_L(1,1)=50$, $P_K(1,1)=50$.",
                },
                {
                    problem: "31. Find the local extrema of $f(x, y) = \\sin(x) \\cos(y)$.",
                },
                {
                    problem: "32. Find the equation of the tangent plane to $z = \\sqrt{x^2+y^2}$ at $(3, 4, 5)$.",
                },
                {
                    problem: "33. If $f(x, y) = x^2 - xy + y^2 - x$, find the directional derivative at $(1, -1)$ in the direction toward the origin.",
                },
                {
                    problem: "34. Find the values of $a, b, c$ such that $f(x, y) = ax^2 + by^2 + cxy$ has a local minimum at $(1, 2)$ with $f(1, 2) = -5$.",
                },
                {
                    problem: "35. Find the maximum value of $f(x, y, z) = x y z$ subject to $x+y+z=1$ (for $x,y,z > 0$).",
                },
                {
                    problem: "36. Find the equation of the tangent plane to $z = \\frac{xy}{x^2+y^2}$ at $(1, 1, 1/2)$.",
                },
                {
                    problem: "37. Determine if $f(x,y) = \\frac{x^2-y^2}{x^2+y^2}$ has a limit as $(x,y) \\to (0,0)$.",
                },
                {
                    problem: "38. Find the domain of $f(x, y, z) = \\ln(x^2+y^2+z^2-1)$.",
                },
                {
                    problem: "39. Find the linear approximation of $f(x, y, z) = \\sqrt{x^2+y^2+z^2}$ at $(3, 2, 6)$.",
                },
                {
                    problem: "40. Find the critical points of $f(x, y) = x^2 + y^2 + xy + 3x - 3y + 4$.",
                },
                {
                    problem: "41. Find the dimensions of a rectangular box with largest volume that can be inscribed in the ellipsoid $\\frac{x^2}{a^2} + \\frac{y^2}{b^2} + \\frac{z^2}{c^2} = 1$.",
                },
                {
                    problem: "42. Find the local extrema of $f(x, y) = x^2 + 4y^2 - 4xy + 2$.",
                },
                {
                    problem: "43. Find the maximum rate of change of $f(x, y, z) = \\ln(x^2+y^2+z^2)$ at $(1, 2, 3)$.",
                },
                {
                    problem: "44. Find the equation of the tangent plane to $xyz = 6$ at $(1, 2, 3)$.",
                },
                {
                    problem: "45. If $u = x^2 y^3$ and $x = r \\cos(\\theta)$, $y = r \\sin(\\theta)$, find $\\frac{\\partial u}{\\partial r}$ and $\\frac{\\partial u}{\\partial \\theta}$.",
                }
            ],
            "13": [
                {
                    problem: "1. Evaluate the iterated integral $\\int_{0}^{1} \\int_{0}^{x} (x+y) dy dx$.",
                },
                {
                    problem: "2. Find the volume of the solid under the surface $z = x^2 y$ and above the rectangle $[0, 1] \\times [0, 2]$.",
                },
                {
                    problem: "3. Evaluate $\\int_{0}^{1} \\int_{y}^{1} e^{x^2} dx dy$ by changing the order of integration.",
                },
                {
                    problem: "4. Evaluate $\\iint_R (x^2+y^2) dA$ where $R$ is the disk $x^2+y^2 \\le 4$.",
                },
                {
                    problem: "5. Find the mass of a lamina with density $\\rho(x, y) = xy$ bounded by $y=x^2$ and $y=x$.",
                },
                {
                    problem: "6. Evaluate the iterated integral $\\int_{0}^{2} \\int_{0}^{\\sqrt{4-x^2}} (x^2+y^2) dy dx$ by converting to polar coordinates.",
                },
                {
                    problem: "7. Find the volume of the solid bounded by the planes $z=0$, $x=0$, $y=0$, and $x+y+z=1$.",
                },
                {
                    problem: "8. Evaluate $\\int_{0}^{1} \\int_{0}^{x} \\int_{0}^{y} xyz dz dy dx$.",
                },
                {
                    problem: "9. Find the center of mass of the solid of constant density $\\rho$ bounded by $x^2+y^2+z^2=1$ in the first octant.",
                },
                {
                    problem: "10. Evaluate $\\iint_R \\sin(x^2+y^2) dA$ where $R$ is the region between $x^2+y^2=1$ and $x^2+y^2=4$.",
                },
                {
                    problem: "11. Evaluate $\\int_{0}^{1} \\int_{x^2}^{x} xy dy dx$.",
                },
                {
                    problem: "12. Find the area of the region bounded by $y=x^2$ and $y=x$.",
                },
                {
                    problem: "13. Evaluate $\\int_{0}^{\\pi/2} \\int_{0}^{\\cos(\\theta)} r \\sin(\\theta) dr d\\theta$.",
                },
                {
                    problem: "14. Find the volume of the solid under the surface $z = x^2$ and above the triangle with vertices $(0,0), (2,0), (0,1)$.",
                },
                {
                    problem: "15. Evaluate $\\int_{0}^{1} \\int_{0}^{\\sqrt{1-y^2}} \\frac{1}{1+x^2+y^2} dx dy$ by converting to polar coordinates.",
                },
                {
                    problem: "16. Find the moments of inertia $I_x, I_y$ for a lamina with density $\\rho(x, y) = 1$ bounded by $y=\\sin(x)$ and $y=0$ for $0 \\le x \\le \\pi$.",
                },
                {
                    problem: "17. Evaluate $\\iiint_E x dV$ where $E$ is the region bounded by $z=x^2+y^2$ and $z=4$.",
                },
                {
                    problem: "18. Evaluate $\\int_{0}^{1} \\int_{0}^{z} \\int_{0}^{y} (x+y+z) dx dy dz$.",
                },
                {
                    problem: "19. Find the volume of the solid enclosed by the cylinder $x^2+y^2=1$ and the planes $z=0$ and $z=x+2$.",
                },
                {
                    problem: "20. Evaluate $\\iint_R e^{-(x^2+y^2)} dA$ where $R$ is the entire plane.",
                },
                {
                    problem: "21. Evaluate $\\int_{0}^{1} \\int_{x}^{1} \\sin(y^2) dy dx$ by changing the order of integration.",
                },
                {
                    problem: "22. Find the area of the surface $z = \\sqrt{x^2+y^2}$ above the disk $x^2+y^2 \\le 1$.",
                },
                {
                    problem: "23. Evaluate $\\int_{0}^{2\\pi} \\int_{0}^{1} \\int_{r}^{1} r dz dr d\\theta$ in cylindrical coordinates.",
                },
                {
                    problem: "24. Find the volume of the solid bounded by the paraboloids $z = x^2+y^2$ and $z = 8 - x^2-y^2$.",
                },
                {
                    problem: "25. Evaluate $\\iiint_E xy dV$ where $E$ is the solid tetrahedron with vertices $(0,0,0), (1,0,0), (0,1,0), (0,0,1)$.",
                },
                {
                    problem: "26. Evaluate $\\int_{0}^{1} \\int_{0}^{x} \\frac{y}{x} dy dx$.",
                },
                {
                    problem: "27. Find the average value of $f(x, y) = x^2+y^2$ over the disk $x^2+y^2 \\le R^2$.",
                },
                {
                    problem: "28. Evaluate $\\iint_R (x^2+y^2) dA$ where $R$ is the region between $x=0, y=x, y=1$.",
                },
                {
                    problem: "29. Find the volume of the solid cut from the sphere $x^2+y^2+z^2=4$ by the cylinder $x^2+y^2=1$.",
                },
                {
                    problem: "30. Evaluate $\\int_{0}^{\\pi/2} \\int_{0}^{\\sin(\\theta)} r dr d\\theta$.",
                },
                {
                    problem: "31. Find the moments of inertia $I_x, I_y$ for a rectangular lamina with vertices $(0,0), (a,0), (a,b), (0,b)$ and constant density $\\rho$.",
                },
                {
                    problem: "32. Evaluate $\\iiint_E z dV$ where $E$ is the region bounded by the sphere $x^2+y^2+z^2=R^2$ in the first octant.",
                },
                {
                    problem: "33. Find the volume of the solid bounded by $z=0$ and $z=4-x^2-y^2$.",
                },
                {
                    problem: "34. Evaluate $\\int_{0}^{1} \\int_{0}^{y} \\int_{0}^{x} xy dz dx dy$.",
                },
                {
                    problem: "35. Find the center of mass of a solid cone of constant density $\\rho$ with radius $R$ and height $H$.",
                },
                {
                    problem: "36. Evaluate $\\iint_R y dA$ where $R$ is the region bounded by $y=x^2$ and $y=1$.",
                },
                {
                    problem: "37. Evaluate $\\int_{0}^{2} \\int_{y/2}^{1} \\cos(x^2) dx dy$ by changing the order of integration.",
                },
                {
                    problem: "38. Find the volume of the solid enclosed by the paraboloid $z=x^2+y^2$ and the plane $z=1$.",
                },
                {
                    problem: "39. Evaluate $\\int_{0}^{2\\pi} \\int_{0}^{\\pi/4} \\int_{0}^{1} \\rho^2 \\sin\\phi d\\rho d\\phi d\\theta$ in spherical coordinates.",
                },
                {
                    problem: "40. Find the area of the region bounded by $x=y^2$ and $x=2-y^2$.",
                },
                {
                    problem: "41. Evaluate $\\iint_R (x-y) dA$ where $R$ is the region bounded by $y=x^2$ and $y=x$.",
                },
                {
                    problem: "42. Find the volume of the solid bounded by the cylinder $x^2+y^2=1$, and the planes $z=0$ and $z=y+1$.",
                },
                {
                    problem: "43. Evaluate $\\int_{0}^{2} \\int_{0}^{x} \\int_{0}^{x-y} dz dy dx$.",
                },
                {
                    problem: "44. Find the surface area of the part of the paraboloid $z=x^2+y^2$ that lies below the plane $z=9$.",
                },
                {
                    problem: "45. Find the center of mass of a lamina with density $\\rho(x,y) = x$ bounded by $y=x^2$ and $y=x$.",
                }
            ],
            "14": [
                {
                    problem: "1. Evaluate the line integral $\\int_C x^2 y ds$ where $C$ is the line segment from $(0,0)$ to $(1,1)$.",
                },
                {
                    problem: "2. Determine if the vector field $\\mathbf{F}(x, y) = \\langle 2xy, x^2 \\rangle$ is conservative. If so, find a potential function.",
                },
                {
                    problem: "3. Evaluate the line integral $\\int_C \\mathbf{F} \\cdot d\\mathbf{r}$ where $\\mathbf{F}(x, y) = \\langle -y, x \\rangle$ and $C$ is the circle $x^2+y^2=1$ oriented counterclockwise.",
                },
                {
                    problem: "4. Apply Green's Theorem to evaluate $\\oint_C (x-y) dx + (x+y) dy$ where $C$ is the circle $x^2+y^2=1$ oriented counterclockwise.",
                },
                {
                    problem: "5. Find the divergence and curl of the vector field $\\mathbf{F}(x, y, z) = \\langle xy, yz, xz \\rangle$.",
                },
                {
                    problem: "6. Evaluate the surface integral $\\iint_S z dS$ where $S$ is the part of the plane $x+y+z=1$ in the first octant.",
                },
                {
                    problem: "7. Evaluate the line integral $\\int_C y dx - x dy$ where $C$ is the parabola $y=x^2$ from $(0,0)$ to $(1,1)$.",
                },
                {
                    problem: "8. Verify the Divergence Theorem for $\\mathbf{F}(x, y, z) = \\langle x, y, z \\rangle$ over the unit cube $[0,1]^3$.",
                },
                {
                    problem: "9. Verify Stokes' Theorem for $\\mathbf{F}(x, y, z) = \\langle -y, x, 0 \\rangle$ over the upper hemisphere of $x^2+y^2+z^2=1$.",
                },
                {
                    problem: "10. Find the work done by the force field $\\mathbf{F}(x, y) = \\langle x^2, xy \\rangle$ on a particle moving along the line segment from $(0,0)$ to $(1,2)$.",
                },
                {
                    problem: "11. Determine if the vector field $\\mathbf{F}(x, y, z) = \\langle yz, xz, xy \\rangle$ is conservative. If so, find a potential function.",
                },
                {
                    problem: "12. Evaluate the line integral $\\int_C (x+y) ds$ where $C$ is the arc of the circle $x^2+y^2=4$ in the first quadrant.",
                },
                {
                    problem: "13. Find the flux of the vector field $\\mathbf{F}(x, y) = \\langle x, y \\rangle$ across the circle $x^2+y^2=1$ (outward normal).",
                },
                {
                    problem: "14. Use Green's Theorem to find the area of the region bounded by the ellipse $\\frac{x^2}{a^2} + \\frac{y^2}{b^2} = 1$.",
                },
                {
                    problem: "15. Find the curl and divergence of $\\mathbf{F}(x, y, z) = \\langle e^x \\sin y, e^x \\cos y, z^2 \\rangle$.",
                },
                {
                    problem: "16. Evaluate the surface integral $\\iint_S \\mathbf{F} \\cdot d\\mathbf{S}$ where $\\mathbf{F}(x, y, z) = \\langle x, y, z \\rangle$ and $S$ is the unit sphere centered at the origin (outward normal).",
                },
                {
                    problem: "17. Evaluate the line integral $\\int_C \\mathbf{F} \\cdot d\\mathbf{r}$ where $\\mathbf{F}(x, y) = \\langle y, -x \\rangle$ and $C$ is the line segment from $(0,0)$ to $(1,1)$.",
                },
                {
                    problem: "18. Apply the Divergence Theorem to find the flux of $\\mathbf{F}(x, y, z) = \\langle xz, yz, z^2 \\rangle$ over the unit sphere.",
                },
                {
                    problem: "19. Evaluate $\\oint_C \\mathbf{F} \\cdot d\\mathbf{r}$ using Stokes' Theorem where $\\mathbf{F}(x, y, z) = \\langle y^2, z^2, x^2 \\rangle$ and $C$ is the triangle with vertices $(1,0,0), (0,1,0), (0,0,1)$ oriented counterclockwise from above.",
                },
                {
                    problem: "20. Find the potential function for $\\mathbf{F}(x, y) = \\langle y \\cos(xy), x \\cos(xy) \\rangle$.",
                },
                {
                    problem: "21. Evaluate the line integral $\\int_C (x-y) dx + (x+y) dy$ where $C$ is the path from $(0,0)$ to $(1,0)$ to $(1,1)$ to $(0,1)$ and back to $(0,0)$.",
                },
                {
                    problem: "22. Find the flux of $\\mathbf{F}(x, y, z) = \\langle x, y, z \\rangle$ across the surface of the cylinder $x^2+y^2=1$ for $0 \\le z \\le 1$ (outward normal).",
                },
                {
                    problem: "23. Evaluate $\\iint_S (\\nabla \\times \\mathbf{F}) \\cdot d\\mathbf{S}$ for $\\mathbf{F}(x, y, z) = \\langle x, y, z \\rangle$ and $S$ is the part of the paraboloid $z = 1-x^2-y^2$ above the xy-plane (upward normal).",
                },
                {
                    problem: "24. Evaluate $\\int_C \\mathbf{F} \\cdot d\\mathbf{r}$ where $\\mathbf{F}(x, y) = \\langle x+y, x-y \\rangle$ and $C$ is the square from $(0,0)$ to $(1,0)$ to $(1,1)$ to $(0,1)$ and back to $(0,0)$.",
                },
                {
                    problem: "25. Find the conservative vector field for $f(x, y) = x^2 y + xy^2$.",
                },
                {
                    problem: "26. Evaluate $\\int_C x^2 dx + y^2 dy$ where $C$ is the line segment from $(0,0)$ to $(1,1)$.",
                },
                {
                    problem: "27. Find the flux of $\\mathbf{F}(x, y) = \\langle y, -x \\rangle$ across the boundary of the square $[0,1] \\times [0,1]$ (outward normal).",
                },
                {
                    problem: "28. Verify Green's Theorem for $\\mathbf{F}(x, y) = \\langle x^2, xy \\rangle$ and $C$ is the unit square $[0,1] \\times [0,1]$.",
                },
                {
                    problem: "29. Find the divergence and curl of the vector field $\\mathbf{F}(x, y, z) = \\langle y, -x, z \\rangle$.",
                },
                {
                    problem: "30. Evaluate the surface integral $\\iint_S \\mathbf{F} \\cdot d\\mathbf{S}$ where $\\mathbf{F}(x, y, z) = \\langle 0, 0, z \\rangle$ and $S$ is the surface of the cylinder $x^2+y^2=4$ from $z=0$ to $z=3$ (outward normal).",
                },
                {
                    problem: "31. Evaluate $\\int_C \\mathbf{F} \\cdot d\\mathbf{r}$ where $\\mathbf{F}(x, y, z) = \\langle yz, xz, xy \\rangle$ and $C$ is the curve parameterized by $\\mathbf{r}(t) = \\langle t, t^2, t^3 \\rangle$ from $t=0$ to $t=1$.",
                },
                {
                    problem: "32. Find the mass of a wire with linear density $\\rho(x,y) = x^2$ along the curve $y=x^2$ from $(0,0)$ to $(1,1)$.",
                },
                {
                    problem: "33. Evaluate $\\iint_S (\\nabla \\times \\mathbf{F}) \\cdot d\\mathbf{S}$ using Stokes' Theorem for $\\mathbf{F}(x, y, z) = \\langle y, z, x \\rangle$ and $S$ is the paraboloid $z = 1-x^2-y^2$ above the xy-plane (upward normal).",
                },
                {
                    problem: "34. Find the potential function for $\\mathbf{F}(x, y, z) = \\langle 2x+y, x+2y+z, y+2z \\rangle$.",
                },
                {
                    problem: "35. Evaluate the line integral $\\int_C \\mathbf{F} \\cdot d\\mathbf{r}$ where $\\mathbf{F}(x, y) = \\langle e^x \\cos y, -e^x \\sin y \\rangle$ and $C$ is any path from $(0,0)$ to $(1, \\pi/2)$.",
                },
                {
                    problem: "36. Find the flux of the vector field $\\mathbf{F}(x, y) = \\langle x^2, y^2 \\rangle$ across the parabola $y=x^2$ from $(0,0)$ to $(1,1)$.",
                },
                {
                    problem: "37. Evaluate $\\iint_S \\text{curl} \\mathbf{F} \\cdot d\\mathbf{S}$ for $\\mathbf{F}(x, y, z) = \\langle yz, xz, xy \\rangle$ and $S$ is the surface of the cube $[0,1]^3$ excluding the bottom face, with outward normal.",
                },
                {
                    problem: "38. Evaluate $\\iiint_E \\text{div} \\mathbf{F} dV$ where $\\mathbf{F}(x, y, z) = \\langle x^2, y^2, z^2 \\rangle$ and $E$ is the unit ball $x^2+y^2+z^2 \\le 1$.",
                },
                {
                    problem: "39. Find the area of the surface $S$ parameterized by $\\mathbf{r}(u, v) = \\langle u, v, u^2+v^2 \\rangle$ for $0 \\le u^2+v^2 \\le 1$.",
                },
                {
                    problem: "40. Evaluate the line integral $\\int_C \\mathbf{F} \\cdot d\\mathbf{r}$ where $\\mathbf{F}(x, y) = \\langle y^2, 2xy \\rangle$ and $C$ is any simple closed path.",
                },
                {
                    problem: "41. Find the conservative vector field for $f(x, y, z) = x y z^2$.",
                },
                {
                    problem: "42. Evaluate $\\int_C x dy - y dx$ where $C$ is the boundary of the region between $y=x^2$ and $y=x$ (oriented counterclockwise).",
                },
                {
                    problem: "43. Find the flux of $\\mathbf{F}(x, y, z) = \\langle xy, y^2, z \\rangle$ through the sphere $x^2+y^2+z^2=1$ (outward normal).",
                },
                {
                    problem: "44. Apply the Divergence Theorem to find the flux of $\\mathbf{F}(x, y, z) = \\langle x, y, z \\rangle$ over the surface of a cylinder $x^2+y^2=R^2$ with height $H$ and caps.",
                },
                {
                    problem: "45. Evaluate $\\oint_C (x+y) dx + (y-x) dy$ where $C$ is the boundary of the region enclosed by $y=x^2$ and $y=x$ (oriented positively).",
                }
            ],
            "15": [
                {
                    problem: "1. State the Divergence Theorem.",
                },
                {
                    problem: "2. State Stokes' Theorem.",
                },
                {
                    problem: "3. Use the Divergence Theorem to find the flux of $\\mathbf{F}(x, y, z) = \\langle x^3, y^3, z^3 \\rangle$ across the unit sphere $S$.",
                },
                {
                    problem: "4. Use Stokes' Theorem to evaluate $\\oint_C \\mathbf{F} \\cdot d\\mathbf{r}$ where $\\mathbf{F}(x, y, z) = \\langle z, x, y \\rangle$ and $C$ is the intersection of $x^2+y^2+z^2=1$ and $z=0$, oriented counterclockwise when viewed from above.",
                },
                {
                    problem: "5. Verify the Divergence Theorem for $\\mathbf{F}(x, y, z) = \\langle x, y, z \\rangle$ over the unit ball $x^2+y^2+z^2 \\le 1$.",
                },
                {
                    problem: "6. Verify Stokes' Theorem for $\\mathbf{F}(x, y, z) = \\langle y, z, x \\rangle$ over the upper hemisphere of $x^2+y^2+z^2=1$ (oriented upward).",
                },
                {
                    problem: "7. Find the divergence of $\\mathbf{F}(x, y, z) = \\langle xy, yz, zx \\rangle$.",
                },
                {
                    problem: "8. Find the curl of $\\mathbf{F}(x, y, z) = \\langle xy, yz, zx \\rangle$.",
                },
                {
                    problem: "9. Use the Divergence Theorem to find the flux of $\\mathbf{F}(x, y, z) = \\langle e^x \\sin y, e^x \\cos y, z \\rangle$ over the box $[0,1] \\times [0,1] \\times [0,1]$.",
                },
                {
                    problem: "10. Use Stokes' Theorem to evaluate $\\oint_C \\mathbf{F} \\cdot d\\mathbf{r}$ where $\\mathbf{F}(x, y, z) = \\langle xz, xy, yz \\rangle$ and $C$ is the boundary of the surface $z = \\sqrt{x^2+y^2}$ for $0 \\le z \\le 1$, oriented counterclockwise when viewed from above.",
                },
                {
                    problem: "11. Calculate the flux of $\\mathbf{F}(x, y, z) = \\langle x^2, y^2, z^2 \\rangle$ across the surface of the cube with vertices $(0,0,0)$, $(1,0,0)$, etc., outward normal.",
                },
                {
                    problem: "12. Evaluate $\\iint_S (\\nabla \\times \\mathbf{F}) \\cdot d\\mathbf{S}$ where $\\mathbf{F}(x, y, z) = \\langle y^2, z^2, x^2 \\rangle$ and $S$ is the surface of the cone $z = \\sqrt{x^2+y^2}$ for $0 \\le z \\le 1$, oriented upward.",
                },
                {
                    problem: "13. State the relationship between Green's Theorem and Stokes' Theorem.",
                },
                {
                    problem: "14. State the relationship between Green's Theorem and the Divergence Theorem (in 2D).",
                },
                {
                    problem: "15. Use the Divergence Theorem to calculate $\\iint_S \\mathbf{F} \\cdot d\\mathbf{S}$ for $\\mathbf{F}(x, y, z) = \\langle x^2, y^2, z^2 \\rangle$ where $S$ is the boundary of the region bounded by $z=x^2+y^2$ and $z=4$.",
                },
                {
                    problem: "16. Use Stokes' Theorem to evaluate $\\oint_C \\mathbf{F} \\cdot d\\mathbf{r}$ for $\\mathbf{F}(x, y, z) = \\langle -y^2, x, z^2 \\rangle$ where $C$ is the curve of intersection of $z=x^2+y^2$ and $z=4$, oriented counterclockwise as viewed from above.",
                },
                {
                    problem: "17. Evaluate $\\iint_S (\\nabla \\times \\mathbf{F}) \\cdot d\\mathbf{S}$ for $\\mathbf{F}(x, y, z) = \\langle x e^y, x e^z, y e^x \\rangle$ and $S$ is the portion of the plane $x+y+z=1$ in the first octant, oriented upward.",
                },
                {
                    problem: "18. Evaluate $\\iiint_E \\text{div}(\\mathbf{F}) dV$ for $\\mathbf{F}(x, y, z) = \\langle x^2+y^2, y^2+z^2, z^2+x^2 \\rangle$ over the unit ball.",
                },
                {
                    problem: "19. Use the Divergence Theorem to find the volume of a solid region $E$ if $\\mathbf{F}(x, y, z) = \\langle x, y, z \\rangle$.",
                },
                {
                    problem: "20. Use Stokes' Theorem to show that $\\oint_C \\nabla f \\cdot d\\mathbf{r} = 0$ for any scalar function $f$ and any closed curve $C$.",
                },
                {
                    problem: "21. Use the Divergence Theorem to calculate the outward flux of $\\mathbf{F}(x, y, z) = \\langle x^2+yz, y^2+xz, z^2+xy \\rangle$ through the boundary of the unit cube $[0,1]^3$.",
                },
                {
                    problem: "22. Use Stokes' Theorem to evaluate $\\oint_C \\mathbf{F} \\cdot d\\mathbf{r}$ for $\\mathbf{F}(x, y, z) = \\langle x^2, y^2, xz \\rangle$ where $C$ is the boundary of the square defined by $0 \\le x \\le 1, 0 \\le y \\le 1, z=0$, oriented counterclockwise.",
                },
                {
                    problem: "23. Find the flux of the curl of $\\mathbf{F}(x, y, z) = \\langle x, xy, xyz \\rangle$ over the surface of a paraboloid $z = 4-x^2-y^2$ for $z \\ge 0$, oriented upward.",
                },
                {
                    problem: "24. Evaluate $\\iint_S \\text{curl}(\\mathbf{F}) \\cdot d\\mathbf{S}$ where $\\mathbf{F}(x, y, z) = \\langle xy^2, yz^2, zx^2 \\rangle$ and $S$ is the portion of the sphere $x^2+y^2+z^2=R^2$ above the xy-plane, oriented upward.",
                },
                {
                    problem: "25. Using the Divergence Theorem, calculate the flux of $\\mathbf{F}(x, y, z) = \\langle x^2+yz, y^2+xz, z^2+xy \\rangle$ out of the unit sphere centered at the origin.",
                },
                {
                    problem: "26. Evaluate $\\oint_C (x-y) dx + (y-z) dy + (z-x) dz$ where $C$ is the boundary of the plane $2x+y+z=2$ in the first octant, oriented counterclockwise as viewed from the positive x-axis.",
                },
                {
                    problem: "27. Find the divergence of $\\mathbf{F}(x, y, z) = \\frac{\\langle x, y, z \\rangle}{(x^2+y^2+z^2)^{3/2}}$.",
                },
                {
                    problem: "28. Find the curl of $\\mathbf{F}(x, y, z) = \\frac{\\langle x, y, z \\rangle}{(x^2+y^2+z^2)^{3/2}}$.",
                },
                {
                    problem: "29. Use the Divergence Theorem to compute the flux of $\\mathbf{F}(x, y, z) = \\langle x, y, z \\rangle$ over the surface of the region bounded by $z = x^2+y^2$ and $z=1$.",
                },
                {
                    problem: "30. Use Stokes' Theorem to calculate $\\oint_C \\mathbf{F} \\cdot d\\mathbf{r}$ for $\\mathbf{F}(x, y, z) = \\langle y^2, x^2, z^2 \\rangle$ where $C$ is the triangle with vertices $(0,0,0), (1,0,0), (0,1,0)$, oriented counterclockwise.",
                },
                {
                    problem: "31. Verify the Divergence Theorem for $\\mathbf{F}(x, y, z) = \\langle xy, y^2, z \\rangle$ over the region bounded by $x=0, x=1, y=0, y=1, z=0, z=1$.",
                },
                {
                    problem: "32. Verify Stokes' Theorem for $\\mathbf{F}(x, y, z) = \\langle z, x, y \\rangle$ where $S$ is the surface $z = \\sqrt{1-x^2-y^2}$ (upper hemisphere) and $C$ is its boundary, oriented counterclockwise.",
                },
                {
                    problem: "33. Use the Divergence Theorem to evaluate $\\iint_S \\mathbf{F} \\cdot d\\mathbf{S}$ for $\\mathbf{F}(x, y, z) = \\langle x+e^{y^2}, y+\\sin(x^2), z+\\cos(x^2+y^2) \\rangle$ over the unit cube.",
                },
                {
                    problem: "34. Use Stokes' Theorem to evaluate $\\oint_C \\mathbf{F} \\cdot d\\mathbf{r}$ where $\\mathbf{F}(x, y, z) = \\langle y^2, z^2, x^2 \\rangle$ and $C$ is the curve formed by the intersection of the cylinder $x^2+y^2=1$ and the plane $z=y+1$, oriented counterclockwise when viewed from above.",
                },
                {
                    problem: "35. Evaluate $\\iint_S (\\nabla \\times \\mathbf{F}) \\cdot d\\mathbf{S}$ for $\\mathbf{F}(x, y, z) = \\langle x^2y, xy^2, xyz \\rangle$ and $S$ is the part of the sphere $x^2+y^2+z^2=4$ that lies above the plane $z=1$, oriented upward.",
                },
                {
                    problem: "36. Evaluate $\\iiint_E \\text{div}(\\mathbf{F}) dV$ where $\\mathbf{F}(x, y, z) = \\langle x^2, y^2, z^2 \\rangle$ and $E$ is the region bounded by $z=x^2+y^2$ and $z=1$.",
                },
                {
                    problem: "37. Use the Divergence Theorem to find the flux of $\\mathbf{F}(x, y, z) = \\langle x^3, y^3, z^3 \\rangle$ across the surface of the cylinder $x^2+y^2=1$ for $0 \\le z \\le 1$, including the top and bottom caps.",
                },
                {
                    problem: "38. Use Stokes' Theorem to evaluate $\\oint_C (x+y) dx + (y+z) dy + (z+x) dz$ where $C$ is the curve of intersection of the plane $x+y+z=1$ and the cylinder $x^2+y^2=1$, oriented counterclockwise when viewed from above.",
                },
                {
                    problem: "39. Evaluate $\\iint_S \\text{curl}(\\mathbf{F}) \\cdot d\\mathbf{S}$ for $\\mathbf{F}(x, y, z) = \\langle e^{xy}, e^{yz}, e^{zx} \\rangle$ and $S$ is the surface of the hemisphere $x^2+y^2+z^2=1$, $z \\ge 0$, oriented upward.",
                },
                {
                    problem: "40. Use the Divergence Theorem to evaluate the flux of $\\mathbf{F}(x, y, z) = \\langle x^2+y^2, y^2+z^2, z^2+x^2 \\rangle$ through the surface of the tetrahedron with vertices $(0,0,0), (1,0,0), (0,1,0), (0,0,1)$.",
                },
                {
                    problem: "41. Verify Stokes' Theorem for $\\mathbf{F}(x, y, z) = \\langle x, y, z \\rangle$ and the surface of a cube excluding one face.",
                },
                {
                    problem: "42. Evaluate $\\iiint_E \\text{div}(\\mathbf{F}) dV$ for $\\mathbf{F}(x, y, z) = \\langle x^2, xy, xz \\rangle$ over the unit sphere.",
                },
                {
                    problem: "43. Use the Divergence Theorem to compute the flux of $\\mathbf{F}(x, y, z) = \\langle x^2, y^2, z^2 \\rangle$ over the surface of the region bounded by the cone $z=\\sqrt{x^2+y^2}$ and the plane $z=1$.",
                },
                {
                    problem: "44. Use Stokes' Theorem to evaluate $\\oint_C \\mathbf{F} \\cdot d\\mathbf{r}$ where $\\mathbf{F}(x, y, z) = \\langle yz, xz, xy \\rangle$ and $C$ is the intersection of the plane $x+y+z=1$ and the coordinate planes (triangle), oriented counterclockwise from above.",
                },
                {
                    problem: "45. Evaluate $\\iint_S \\text{curl}(\\mathbf{F}) \\cdot d\\mathbf{S}$ for $\\mathbf{F}(x, y, z) = \\langle \\sin(yz), x\\cos(yz), x^2y \\rangle$ and $S$ is the part of the sphere $x^2+y^2+z^2=4$ that lies above the plane $z=0$, oriented upward.",
                }
            ],
            "16": [
                {
                    problem: "1. Find the general solution of $y'' + 4y' + 3y = 0$.",
                },
                {
                    problem: "2. Solve the initial value problem $y'' - 2y' + y = 0$, $y(0)=1$, $y'(0)=0$.",
                },
                {
                    problem: "3. Find the general solution of $y'' + 9y = 0$.",
                },
                {
                    problem: "4. Find the general solution of $y'' - y = e^x$.",
                },
                {
                    problem: "5. Use variation of parameters to solve $y'' + y = \\tan(x)$.",
                },
                {
                    problem: "6. Find the general solution of $y'' - 5y' + 6y = 0$.",
                },
                {
                    problem: "7. Solve the initial value problem $y'' + 2y' + 2y = 0$, $y(0)=1$, $y'(0)=-1$.",
                },
                {
                    problem: "8. Find the general solution of $y'' - 4y' + 4y = 0$.",
                },
                {
                    problem: "9. Find the general solution of $y'' + y = x^2$.",
                },
                {
                    problem: "10. A mass-spring system has a mass of 1 kg, a damping constant of 2 Ns/m, and a spring constant of 10 N/m. If the mass is initially displaced 0.1 m and released from rest, find the position of the mass as a function of time.",
                },
                {
                    problem: "11. Find the general solution of $y'' + 3y' - 4y = 0$.",
                },
                {
                    problem: "12. Solve the initial value problem $y'' + y = 0$, $y(\\pi/2)=2$, $y'(\\pi/2)=-1$.",
                },
                {
                    problem: "13. Find the general solution of $y'' + 2y' + 5y = 0$.",
                },
                {
                    problem: "14. Find the general solution of $y'' - y' - 2y = \\sin(x)$.",
                },
                {
                    problem: "15. Use variation of parameters to solve $y'' - 2y' + y = \\frac{e^x}{x}$.",
                },
                {
                    problem: "16. Find the general solution of $y''' - 4y'' + 4y' = 0$.",
                },
                {
                    problem: "17. Find the general solution of $y'' + 4y = \\cos(2x)$.",
                },
                {
                    problem: "18. Solve the initial value problem $y'' + 6y' + 9y = 0$, $y(0)=0$, $y'(0)=1$.",
                },
                {
                    problem: "19. Find the general solution of $y'' - 3y' = e^{3x}$.",
                },
                {
                    problem: "20. A series RLC circuit has $R=10 \\Omega$, $L=1$ H, $C=0.1$ F. If the initial charge on the capacitor is $Q(0)=1$ C and initial current is $I(0)=0$, find $Q(t)$.",
                },
                {
                    problem: "21. Find the general solution of $y'' + 5y' + 6y = e^{-x}$.",
                },
                {
                    problem: "22. Solve the initial value problem $y'' - y = 0$, $y(0)=2$, $y'(0)=0$.",
                },
                {
                    problem: "23. Find the general solution of $y'' + 2y' + y = e^{-x} \\ln(x)$.",
                },
                {
                    problem: "24. Find the general solution of $y^{(4)} - y = 0$.",
                },
                {
                    problem: "25. Find the general solution of $y'' + 2y' + y = \\sin(x)$.",
                },
                {
                    problem: "26. Find the general solution of $y'' - y = x^2 e^x$.",
                },
                {
                    problem: "27. Solve the initial value problem $y'' + 4y = \\sin(x)$, $y(0)=0$, $y'(0)=0$.",
                },
                {
                    problem: "28. Find the general solution of $y'' + 2y' + 10y = 0$.",
                },
                {
                    problem: "29. Find the general solution of $y'' - 3y' + 2y = e^{3x}$.",
                },
                {
                    problem: "30. A critically damped mass-spring system has characteristic equation $r^2+2r+1=0$. If the initial position is 1 and initial velocity is 0, find the position function.",
                },
                {
                    problem: "31. Find the general solution of $y'' + y = \\csc(x)$.",
                },
                {
                    problem: "32. Find the general solution of $y'' - 2y' + 5y = e^x \\cos(2x)$.",
                },
                {
                    problem: "33. Solve the initial value problem $y'' - 6y' + 8y = 0$, $y(0)=3$, $y'(0)=2$.",
                },
                {
                    problem: "34. Find the general solution of $y'' + 3y' + 2y = \\sinh(x)$.",
                },
                {
                    problem: "35. A forced undamped mass-spring system is described by $y'' + 4y = \\cos(t)$. Find the general solution.",
                },
                {
                    problem: "36. Find the general solution of $y'' + 2y' - 3y = e^x + x$.",
                },
                {
                    problem: "37. Find the general solution of $y^{(4)} - 5y'' + 4y = 0$.",
                },
                {
                    problem: "38. Solve the initial value problem $y'' + 9y = 2\\cos(3x)$, $y(0)=0$, $y'(0)=0$.",
                },
                {
                    problem: "39. Find the general solution of $x^2 y'' - 2xy' + 2y = 0$. (Cauchy-Euler equation)",
                },
                {
                    problem: "40. An oscillating circuit is described by $Q'' + 2Q' + Q = 0$. If $Q(0)=1, Q'(0)=0$, find the charge on the capacitor.",
                },
                {
                    problem: "41. Find the general solution of $y'' + y = \\sec(x)$.",
                },
                {
                    problem: "42. Find the general solution of $y'' - 4y' + 5y = e^{2x} \\sin(x)$.",
                },
                {
                    problem: "43. Solve the initial value problem $y'' - 2y' - 3y = 3e^{2x}$, $y(0)=1, y'(0)=0$.",
                },
                {
                    problem: "44. Find the general solution of $y'' + y = x \\cos(x)$.",
                },
                {
                    problem: "45. Find the general solution of $y''' - 6y'' + 11y' - 6y = 0$.",
                }
            ],
            "Appendices": [
                {
                    problem: "1. Simplify the expression: $\\frac{x^2 - 9}{x^2 - 6x + 9}$.",
                },
                {
                    problem: "2. Solve for $x$: $\\log_2(x) + \\log_2(x-2) = 3$.",
                },
                {
                    problem: "3. If $f(x) = \\frac{1}{x}$ and $g(x) = x^2 - 1$, find $(f \\circ g)(x)$ and state its domain.",
                },
                {
                    problem: "4. Solve the inequality: $|2x - 3| < 5$.",
                },
                {
                    problem: "5. Find the exact value of $\\sin(\\frac{7\\pi}{6})$.",
                },
                {
                    problem: "6. Find the equation of the line passing through $(2, 5)$ and parallel to $3x - y = 7$.",
                },
                {
                    problem: "7. Express $\\frac{e^x + e^{-x}}{2}$ in terms of hyperbolic functions.",
                },
                {
                    problem: "8. Evaluate $\\int_0^1 \\sqrt{1-x^2} dx$ geometrically.",
                },
                {
                    problem: "9. Prove that $\\frac{d}{dx}(\\sec x) = \\sec x \\tan x$.",
                },
                {
                    problem: "10. Find the inverse of the function $f(x) = x^3 + 1$.",
                },
                {
                    problem: "11. Simplify: $\\frac{x^{1/2} y^{2/3}}{x^{1/4} y^{1/3}}$.",
                },
                {
                    problem: "12. Convert $45^{\\circ}$ to radians.",
                },
                {
                    problem: "13. Sketch the graph of $y = |x - 2| + 1$.",
                },
                {
                    problem: "14. Solve the equation: $e^{2x} - 3e^x + 2 = 0$.",
                },
                {
                    problem: "15. If $\\cos(\\theta) = -\\frac{3}{5}$ and $\\theta$ is in Quadrant III, find $\\sin(\\theta)$.",
                },
                {
                    problem: "16. Find the distance from the point $(1, 2)$ to the line $y = 2x - 3$.",
                },
                {
                    problem: "17. Evaluate $\\lim_{x \\to 0} \\frac{\\sqrt{1+x}-1}{x}$.",
                },
                {
                    problem: "18. Express the complex number $3+4i$ in polar form.",
                },
                {
                    problem: "19. Prove that the derivative of a sum is the sum of the derivatives: $(f+g)' = f'+g'$.",
                },
                {
                    problem: "20. Find the equation of the circle with center $(1, -3)$ and radius $4$.",
                },
                {
                    problem: "21. Simplify: $\\frac{1}{x} + \\frac{1}{x+1}$.",
                },
                {
                    problem: "22. Solve for $x$: $4^x = 8$.",
                },
                {
                    problem: "23. Determine if the function $f(x) = \\frac{1}{x^2+1}$ is even, odd, or neither.",
                },
                {
                    problem: "24. Find the domain of $f(x) = \\frac{1}{\\ln(x)}$.",
                },
                {
                    problem: "25. Find the exact value of $\\tan(\\frac{5\\pi}{4})$.",
                },
                {
                    problem: "26. Find the general solution of $y'' + y = 0$.",
                },
                {
                    problem: "27. Use implicit differentiation to find $\\frac{dy}{dx}$ for $x^2 + y^2 = 25$.",
                },
                {
                    problem: "28. Express the vector $\\langle 3, -4 \\rangle$ in terms of unit vectors $\\mathbf{i}$ and $\\mathbf{j}$.",
                },
                {
                    problem: "29. Explain the concept of a removable discontinuity.",
                },
                {
                    problem: "30. Find the partial fraction decomposition of $\\frac{1}{x(x+1)}$.",
                },
                {
                    problem: "31. Simplify: $(\\sqrt{x} + \\sqrt{y})(\\sqrt{x} - \\sqrt{y})$.",
                },
                {
                    problem: "32. Solve for $x$: $\\ln(x^2) = 4$.",
                },
                {
                    problem: "33. Determine if the sequence $a_n = (-1)^n$ converges or diverges.",
                },
                {
                    problem: "34. Convert the polar point $(3, \\pi)$ to rectangular coordinates.",
                },
                {
                    problem: "35. Find the area of a sector with radius 5 and angle $\\frac{\\pi}{4}$ radians.",
                },
                {
                    problem: "36. Find the equation of the ellipse with foci $(\\pm 3, 0)$ and vertices $(\\pm 5, 0)$.",
                },
                {
                    problem: "37. Define a function that is continuous everywhere but not differentiable at $x=0$.",
                },
                {
                    problem: "38. Evaluate $\\int \\frac{1}{\\sqrt{x}} dx$.",
                },
                {
                    problem: "39. Prove that $\\cos^2 x + \\sin^2 x = 1$.",
                },
                {
                    problem: "40. Find the value of $k$ such that the lines $y=kx+2$ and $y=3x-1$ are perpendicular.",
                },
                {
                    problem: "41. Simplify: $(x^2 y^3)^2 / (xy)^4$.",
                },
                {
                    problem: "42. Solve for $x$: $2^{2x+1} = 32$.",
                },
                {
                    problem: "43. Determine if the series $\\sum_{n=1}^{\\infty} \\frac{1}{n}$ converges or diverges.",
                },
                {
                    problem: "44. Find the domain of $f(x) = \\arcsin(x)$.",
                },
                {
                    problem: "45. Find the exact value of $\\cos(75^{\\circ})$.",
                }
            ]
        };
        ...
        const modalProblemsContent = document.getElementById('modalProblemsContent');
        const viewProblemsButtons = document.querySelectorAll('.view-problems-btn');

        viewProblemsButtons.forEach(button => {
            button.addEventListener('click', (event) => {
                const chapterKey = event.target.dataset.chapter;
                const problems = practiceProblems[chapterKey];
                
                modalChapterTitle.textContent = `Chapter ${chapterKey} Practice Problems`;
                modalProblemsContent.innerHTML = ''; // Clear previous problems

                if (problems) {
                    problems.forEach((item, index) => {
                        const problemDiv = document.createElement('div');
                        problemDiv.classList.add('problem-item', 'mb-6');
                        problemDiv.innerHTML = `
                            <p class="font-semibold text-gray-800 mb-2">${item.problem}</p>
                        `;
                        modalProblemsContent.appendChild(problemDiv);
                    });
                } else {
                    modalProblemsContent.innerHTML = '<p>No practice problems available for this chapter yet.</p>';
                }

                modal.classList.add('open');
                MathJax.typesetPromise(); // Render MathJax in the modal
            });
        });
